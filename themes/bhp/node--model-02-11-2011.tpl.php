						...
						<div class="fleft w380 PhotoGallery">									
							<div class="photogalleryHolder marB10">
								...
								$cnt_withseq=0;
									...
									<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>"<?php if($cnt_withseq==0) {?> id="mainPhoto" alt="<?php echo $d_singleextimg['title']; ?>"<?php }?> />
								...
								<?php
									...
									?>
									<img src="http://www.team-bhp.com/<?php echo $model_imgname;?>" id="mainPhoto" alt="<?php echo $node->title; ?>" />
								...
								<?php	
									...
									$model_imgnamewithoutseq="?q=sites/default/files/styles/check_large_review/public/".str_replace("public://","",$model_img['uri']);
									?>
										<a href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" class="lightbox mainPhoto" title="<?php echo $node->title; ?>" <?php if($cnt_withseq==0) {?> style="display:block"<?php } else {?> style="display:none"<?php } if($cnt_withseq==0) {?> id="mainfoto"<?php }?> rel="lightbox[model]">
									<img src="http://www.team-bhp.com/<?php echo $model_imgnamewithoutseq;?>" <?php if($cnt_withseq==0) {?> id="mainPhoto"<?php }?> alt="<?php echo $node->title; ?>" />
									<a href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" title="<?php echo $d_singleextimg['title']; ?>" class="lightbox zoomIt" rel="lightbox[model]" <?php if($cnt_withseq==0) {?> style="display:block" id="lboxsrc" <?php } else {?> style="display:none" title="<?php echo $d_singleextimg['title']; ?>"<?php }?>>&nbsp;</a>
										</a>
									<?php
											$cnt_withseq++;
											}
								...
								?>
								 <ul class="gallery_thumb clearfix marT10 marB5">
									 ...
									 <li>
										...
										<a <?php if($count_last==1) {?>class="active"<?php } else if ($count_last==$num_exterior) { ?>class="last"<?php }?> href="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$sql_imgpath['uri']);?>" title="<?php echo $data_ext_img['title'];?>">
											<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> -->
									     	<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_thumb_review_detail/public/<?php echo str_replace("public://","",$sql_imgpath['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" /> 
										</a>
									</li>
									<?php
											$count_last++;
									...
									if(@mysqli_num_rows($q_withoutseq)>0)
								 	...
								 	<?php
								 		...
								 		while($data_withoutorder_img1111=@mysqli_fetch_array($q_withoutseq))
											...
											$model_imgname="?q=sites/default/files/styles/check_thumb_review_detail/public/".str_replace("public://","",$sql_imgpath['uri']);
											$model_imgnamelarge="?q=sites/default/files/styles/check_large_review/public/".str_replace("public://","",$sql_imgpath['uri']);
								 	?>
									 <li>
									
										<a <?php if($count_last==1) {?>class="active"<?php } else if ($count_last==@mysqli_num_rows($q_withoutseq)) { ?>class="last"<?php }?> href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" title="<?php echo $data_withoutorder_img['title'];?>">
											<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> -->
									     	<img src="http://www.team-bhp.com/<?php echo $model_imgname;?>" alt="<?php echo $data_withoutorder_img['title'];?>" /> 
										</a>
									</li>
									<?php
											$count_last++;
									...
									<div class="reviewSummery clearfix roundAll5 marB10">
										...
										<div id="firstPage">
											...
											<div style="display: none;" id="secondPage">
												...
												<?php
													echo "<p>".$smaller_sign."<a href='#prev_page' id='prev_pagefordetail' onclick='return false;' title='Overview'>< Overview"."</a></p>"."<div class='clearfix InnerPagination fright'><ul class='pagination'><li><a href='#prev_page'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a   class='active'>2</a></li></ul></div>";
												?>
											</div>
						...
						<ul class="clearfix" id="compareUL">
							...
							<li class="clearfix">
								<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>" rel="<?php echo str_replace("review/","",$sql_url['alias'])?>">
									...
									<img src="http://www.team-bhp.com/<?php echo $model_modleimgname;?>" alt="<?php echo $data_model['title'];?>" />
									</div>
									<p class="desc">
