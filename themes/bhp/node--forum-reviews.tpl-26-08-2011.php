											...
											<div class="clearfix listHolder">
												<div class="fleft w170">
													<a href="<?php echo $sql_link['field_forum_link_url'];?>" title="<?php echo $sql_title['title'];?>" target="_blank">
														...
														<img src="http://www.team-bhp.com/?q=sites/default/files/styles/medium_medium/public/<?php echo str_replace("public://","",$sql_image['uri']);?>" alt="<?php echo $sql_title['title'];?>" width="165" height="124" /> 
													</a>
						...
						<ul class="clearfix" id="compareUL">
							...
							<li class="clearfix">
								<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>" rel="<?php echo str_replace("review/","",$sql_url['alias'])?>">
									...
									<img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_review_detail/public/<?php echo str_replace("public://","",$data_model['uri']);?>" alt="<?php echo $mktitle['title']." ".$data_model['title'];?>" width="61" height="46" />
									</div>
									<p class="desc">
