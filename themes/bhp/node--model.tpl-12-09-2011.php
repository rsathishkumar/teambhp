					...
					<div class="clearfix marT10">
						<div class="fleft w380 PhotoGallery">									
							<div class="photogalleryHolder marB10">
									...
									?>
									<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>" class="lightbox mainPhoto" id="mainfoto" title="<?php echo $d_singleextimg['title']; ?>">
								...
								<?php	
									...
									?>
										<a href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" class="lightbox mainPhoto" title="<?php echo $node->title; ?>">
									<img src="http://www.team-bhp.com/<?php echo $model_imgnamewithoutseq;?>" id="mainPhoto" alt="<?php echo $node->title; ?>" />
									<a href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" title="<?php echo $d_singleextimg['title']; ?>" class="lightbox zoomIt">&nbsp;</a>
										</a>
									<?php
										}
									}
									...
									<div class="reviewSummery clearfix roundAll5 marB10">
										...
										<div id="firstPage">
											...
											$summary="";
												...
												if($summary!='')
													...
													//echo "<p>".$smaller_sign."</p>"."<div class='clearfix InnerPagination fright'><ul class='pagination'><li><a href='#'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a  title='go to page 2' class='active'>2</a></li></ul></div>";
														if($node->field_review_smaller['und'][0]['value']!='')
														{
														echo "<p>".trim($summary."<a href='#secondPage' id='goToNextPagefordetail' class='underline' title='Next Page'>&hellip;"."Next Page"."</a>")."</p>";	
														}
														else
														{
											...
											<div style="display: none;" id="secondPage">
												...
												<?php
													echo "<p>".$smaller_sign."<a href='#prev_page' id='prev_pagefordetail' onclick='return false;'>Prev Page"."</a></p>"."<div class='clearfix InnerPagination fright'><ul class='pagination'><li><a href='#prev_page'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a   class='active'>2</a></li></ul></div>";
												?>
											</div>
