...
?>
	...
	function explode (delimiter, string, limit) {
		...
		function mycarousel_initCallback1(carousel1, state) {
		    jQuery('.controls .next').live("click", function(){
		    	if(pos%4==0)
		    	{
		    ...
		    jQuery('.controls .prev').live("click", function(){
		    	if(pos%4==3)
		    	{
		    	carousel1.scroll(jQuery.jcarousel.intval(pos-2));
		    	}
		    });
		};
	...
	?>
							...
							<div class="Overview">
								<div class="carOverview BLR5 marB10">
											...
											<div class="reviewPhoto" id="gallery">
												<?php
													...
													while($data_ext_img1=mysqli_fetch_array($sql_exterior_img1))
														...
														?>
														<span<?php if($cnt==1) {?> class="show"<?php }?>>
															<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_photo_gallery/public/<?php echo str_replace("public://","",$data_ext_img1['uri']);?>" alt="<?php echo $data_ext_img1['field_gallery_exterior_title'];?>"  title="<?php echo $data_ext_img1['field_gallery_exterior_title'];?>" />
														</span>
														<?php
															$cnt++;
													    }
									...
									<div class="jcarousel-skin-tango clearfix">
											...
											<a <?php if($counter==0) {?>class="active"<?php }?>onclick="return showMain(<?php echo $counter;?>);" title="<?php echo $sql_imgtitle['title'];?>" href="#">
												<span class="photosBucketImg">
													<strong>
														<img alt="<?php echo $sql_imgtitle['title'];?>" src="http://www.team-bhp.com/?q=sites/default/files/styles/check_medium_medium/public/<?php echo str_replace("public://","",$data_ext_imgnew['uri']);?>" />
													</strong>
												</span>
											</a>
											</li>
											...
											<a <?php if($counter==0) {?>class="active"<?php }?>onclick="return showMain(<?php echo $counter;?>);" title="<?php echo $sql_imgtitle1['title'];?>" href="#">
												<span class="photosBucketImg">
													<strong>
														<img alt="<?php echo $sql_imgtitle1['title'];?>" src="http://www.team-bhp.com/?q=sites/default/files/styles/check_medium_medium/public/<?php echo str_replace("public://","",$data_ext_imgnew1['uri']);?>" />
													</strong>
												</span>
											</a>
											</li>
									...
									?>
										<li>
											<a href="http://www.team-bhp.com/?q=sites/default/files/styles/extra_large_for_review/public/<?php echo str_replace("public://","",$data_ext_imgnew['uri']);?>" title="<?php echo $sql_imgtitle['title'];?>" rel="lightbox[all]">
												...
												<span class="photosBucketImg">
													<strong>
													<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_medium_medium/public/<?php echo str_replace("public://","",$data_ext_imgnew['uri']);?>" alt="<?php echo $sql_imgtitle['title'];?>" />
													</strong>
												</span>
									...
									?>
										<li>
											<a href="http://www.team-bhp.com/?q=sites/default/files/styles/extra_large_for_review/public/<?php echo str_replace("public://","",$data_ext_imgnew1['uri']);?>" title="<?php echo $sql_imgtitle1['title'];?>" rel="lightbox[all]">
												<!--<img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$data_ext_imgnew['uri']);?>" alt="<?php echo $sql_imgtitle['title'];?>" width="165" height="124" />-->
												<span class="photosBucketImg">
													<strong>
													<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_medium_medium/public/<?php echo str_replace("public://","",$data_ext_imgnew1['uri']);?>" alt="<?php echo $sql_imgtitle1['title'];?>" />
													</strong>
												</span>
												...
												if($price_res['maxPrice']>=100000)
													...
													<li class="clearfix">
														<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>"  rel="<?php echo str_replace("review/","",$sql_url['alias'])?>">
															<div class="img">
																<strong>
																<img src="http://www.team-bhp.com/<?php echo $model_modleimgname;?>" alt="<?php echo $data_model['title'];?>" title="<?php echo $data_model['title'];?>" />
																</strong>
															</div>
															<p class="desc">
