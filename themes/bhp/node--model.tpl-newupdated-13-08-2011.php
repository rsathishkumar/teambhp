					...
					<div class="clearfix marT10">
						<div class="fleft w380 PhotoGallery">									
							<div class="photogalleryHolder marB10">
									...
									?>
								<a href="http://www.team-bhp.com/?q=sites/default/files/styles/large_review/public/<?php echo str_replace("public://","",$d_singleextimg['uri']);?>" class="lightbox mainPhoto" title="<?php echo $node->title; ?>">
									...
									<img src="http://www.team-bhp.com/sites/default/files/styles/large_review/public/<?php echo str_replace("public://","",$d_singleextimg['uri']);?>" id="mainPhoto" alt="<?php echo $node->title; ?>" width="370" height="278" />
								<?php
										}
										else
										{
...
$sql_interior_img=@mysqli_query("SELECT node.title, field_data_field_gallery_model.field_gallery_model_nid, field_data_field_gallery_interior.field_gallery_interior_fid , file_managed.uri FROM node, file_managed, field_data_field_gallery_interior, field_data_field_gallery_model WHERE field_data_field_gallery_interior.entity_id = field_data_field_gallery_model.entity_id AND file_managed.fid = field_data_field_gallery_interior.field_gallery_interior_fid  AND field_data_field_gallery_model.field_gallery_model_nid =".$node->nid." AND field_data_field_gallery_model.field_gallery_model_nid = node.nid order by field_data_field_gallery_interior.field_gallery_interior_fid desc limit 0,1") ;
								...
								?>
								 <ul class="gallery_thumb clearfix marT10 marB5">
								 	...
								 	?>
									<li>
										<a class="active" href="http://www.team-bhp.com/?q=sites/default/files/styles/large_review/public/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" title="<?php echo $data_ext_img['title'];?>">
											<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> -->
									     	<img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_review_detail/public/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> 
										</a>
									</li>
									<?php
											}
									...
									?>
									<li>
										<a href="http://www.team-bhp.com/?q=sites/default/files/styles/large_review/public/<?php echo str_replace("public://","",$data_int_img['uri']);?>" title="<?php echo $data_int_img['title'];?>" class="last">
											<img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_review_detail/public/<?php echo str_replace("public://","",$data_int_img['uri']);?>" alt="<?php echo $data_int_img['title'];?>" width="70" height="53" />
										</a>
									</li>
										<?php
										}
							...
							if($node->field_review_summary['und'][0]['value']=='')
									{
										...
										if($furl!='')
											...
											$flagtoshow=0;
							?>
							<br /><a href="<?php if($restofind=='') { echo "http://";} echo $furl;?>" target="_blank" class="discussBtn"><span>View Forum Discussion</span></a>
							<?php
											}
									}
									else
		...
		//$sql_modelengine=@mysqli_query("select field_spec_nr_engine_type_nid from field_data_field_spec_nr_engine_type where entity_id in(".substr($e_id,0,-1).") and bundle ='specifications'");
							...
							<!-- <br /><a href="<?php if($restofind=='') { echo "http://";} echo $furl;?>" target="_blank" class="discussBtn"><span>View Forum Discussion</span></a>-->
								...
								if($node->field_model_link_available['und'][0]['value']=='Yes' and $node->field_model_moderator_link['und'][0]['url']!='')
										{
										$restofindmod=strstr($node->field_model_moderator_link['und'][0]['url'],"http://");
										
								?>
								<div class="clearfix marT20 marB20">
											View the in-depth review of this car by a Team-BHP Moderator: <br />
										<!--  <a href="#" id="overviewmore" title="<?php echo $node->title;?>" class="underline"><?php echo $node->title;?> Review</a>-->
										 <a href="<?php if($restofindmod=='') { echo "http://";} echo $node->field_model_moderator_link['und'][0]['url'];?>" target="_blank" title="<?php echo $make_res['title'].": ". $node->title." Review";?>" class="underline"><?php echo $make_res['title'].": ". $node->title;?> Review</a>
								</div>
								<?php
										}
										...
										<div id="firstPage">
											...
											$summary="";
												...
												if($node->field_review_smaller['und'][0]['value']!='')
													...
													if($node->field_review_smaller['und'][0]['value']!='')
														{
													$summary.="<div class='clearfix InnerPagination'><ul class='pagination'><li class='active'><a href='#prev_page' class='active' title='go to page 1'>1</a></li><li><a href='#secondPage' title='go to page 2' id='goToNextPage'>2</a></li></ul></div>";
														}
												if($summary!='')
													{
											...
											<div style="display: none;" id="secondPage">
												...
												<ul class="blackBullet">
													...
													$smaller_sign=str_replace("</p>","",$smaller_sign);
													//echo "<p>".$smaller_sign."<a href='#prev_page' id='prev_page' title='Previous Page'><div class='clearfix InnerPagination'><ul class='pagination'><li class='first'>1</li><li class='active'>2</li></ul></div>"."</a>";
													echo "<p>".$smaller_sign."</p>"."<div class='clearfix InnerPagination'><ul class='pagination'><li><a href='#prev_page'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a href='#secondPage' title='go to page 2' class='active'>2</a></li></ul></div>";
