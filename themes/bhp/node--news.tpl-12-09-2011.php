						...
						<div class="full_news marT10 clearfix">
							...
							<div class="fleft PhotoGallery">
								...
								if(sizeof($node->field_news_images['und'])>0)
									 {
									?>
										<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][0]['uri']);?>" class="lightbox mainPhoto" title="<?php echo $node->title;?> ">
											...
											<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][0]['uri']);?>" id="mainPhoto" alt="<?php echo $node->title;?>"  alt="<?php echo $node->title;?> " />
											<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][0]['uri']);?>" title="<?php echo $node->title;?>" class="lightbox zoomIt">&nbsp;</a>
										</a>
									<?php 											
									}
