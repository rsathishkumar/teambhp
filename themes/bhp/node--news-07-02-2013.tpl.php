...
<div id="leftColumn" class="clearfix fleft">
		<div class="article">
			...
			<ul class="tab TLR5 clearfix">
				<li><a href="#" class="TLR5" title="%">All</a></li>
				<li><a href="#" class="TLR5<?php if($node->field_news_category['und'][0]['value']=='Indian') { ?> active<?php } ?>" title="Indian">Indian</a></li>
				<li><a href="#" class="TLR5<?php if($node->field_news_category['und'][0]['value']=='International') { ?> active<?php } ?>" title="International">International</a></li>
				<li><a href="#" class="TLR5<?php if($node->field_news_category['und'][0]['value']=='Motor Sports') { ?> active<?php } ?>" title="Motor Sports">Motor Sports</a></li>
			</ul>
							...
							<div class="fleft PhotoGallery" id="mainfotocontainer">
								...
								if(sizeof($node->field_news_images['und'])>0)
									 ...
									 while($data_news=mysql_fetch_assoc($sql_imglist))
									 	{
									?>
										<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$data_news['uri']);?>" class="lightbox mainPhoto<?php  if($cnt_newsimg==0) { ?> active<?php } ?>"<?php if($cnt_newsimg==0) {?> style="display:table"<?php } else {?> style="display:none"<?php }?> title="<?php echo $node->title;?>" rel="lightbox[news]">
											...
											<strong>
												<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",str_replace(" ","%20",$data_news['uri']));?>"<?php if($cnt_newsimg==0) {?> id="mainPhoto"<?php } ?> alt="<?php echo $node->title;?> " />
											</strong>
										</a>
										<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$data_news['uri']);?>" title="<?php echo $node->title;?>" class="lightbox zoomIt"<?php if($cnt_newsimg==0) {?> style="display:block"<?php } else {?> style="display:none"<?php }?>  rel="lightbox[news]">&nbsp;</a>
									<?php
									$cnt_newsimg++;
										}
									}
									...
									<ul class="gallery_thumb marT10 clearfix marB5">
										...
										<li>
											...
											<a class="active" href="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][0]['uri']);?>" title="<?php echo $node->title;?>">
												<strong>
												...
												<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_thumb_review_detail/public/<?php echo str_replace("public://","",$node->field_news_images['und'][0]['uri']);?>" alt="<?php echo $node->title?>" />
												</strong>
											</a>
										...
										?>
										<li>
											<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][1]['uri']);?>" title="<?php echo $node->title?>">
												<strong>
												<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_thumb_review_detail/public/<?php echo str_replace("public://","",$node->field_news_images['und'][1]['uri']);?>" alt="<?php echo $node->title?>" />
												</strong>
											</a>
										</li>
										<?php
										...
										?>
										<li>
											<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][2]['uri']);?>" title="<?php echo $node->title?>">
												<strong>
												<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_thumb_review_detail/public/<?php echo str_replace("public://","",$node->field_news_images['und'][2]['uri']);?>" />
												</strong>
											</a>
										</li>
										<?php
										...
										?>
										<li>
											<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$node->field_news_images['und'][3]['uri']);?>" title="<?php echo $node->title?>" class="last">
												<strong>
												<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_thumb_review_detail/public/<?php echo str_replace("public://","",$node->field_news_images['und'][3]['uri']);?>" alt="<?php echo $node->title?>"  />
												</strong>
											</a>
										</li>
										<?php
