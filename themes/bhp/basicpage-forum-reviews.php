...
$sql_f="select field_data_field_forum_model.field_forum_model_nid,field_data_field_forum_model.entity_id,field_data_field_position.field_position_value from field_data_field_forum_model,field_data_field_position where field_forum_model_nid=".$sql_modeldata['field_forum_model_nid']." and field_data_field_position.entity_id = field_data_field_forum_model.entity_id order by  field_data_field_position.field_position_value";
		...
		if(intval($no)>=100000)
		...
		else
			{
				return 0;
											...
											if($nofff>0)
												{
	function truncate($text, $length = '', $ending = '...', $exact = false, $considerHtml = true) 
			{
				if ($considerHtml) 
				{
							...
							<div class="tab_content forum clearfix" style="display:block">
								<div class="clearfix marB10">
										<div class="fleft w480 padL20">
											...
											<h1><?php echo $node_data->title;?> <span>Forum Reviews</span></h1>
										</div>
								...
								<div class="forumLeft clearfix fleft">
									<ul class="newslist">
										...
										?>
										<li rel="<?php echo $sql_link['field_forum_link_url'];?>">
											<div class="listHolder clearfix">
												<div class="fleft w170">
													<a class="holderImg" href="<?php echo $sql_link['field_forum_link_url'];?>" title="<?php echo $sql_title['title'];?>" target="_blank">
														<!-- <img src="/sites/default/files/<?php echo str_replace("public://","",$sql_image['uri']);?>" alt="<?php echo $sql_title['title'];?>" width="165" height="124" /> -->
														<strong>
														<img src="/?q=sites/default/files/styles/check_medium_medium/public/<?php echo str_replace("public://","",$sql_image['uri']);?>" alt="<?php echo $sql_title['title'];?>" /> 
														</strong>
													</a>
												...
												<div class="fright w460 ShortNews">
													...
													<div class="past_shornote">
																<?php
																echo truncate($sql_forumreview['field_forum_review_description_value'], 210	, '...', false,true);
																?>
													</div>
												</div><!-- w460 -->
											</div><!-- List holder  -->
						...
						<ul class="clearfix" id="compareUL">
							...
							<li class="clearfix">
								<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>" rel="<?php echo str_replace("review/","",$sql_url['alias'])?>">
									<div class="img">
									<strong>
									<!-- <img src="/sites/default/files/<?php echo str_replace("public://","",$data_model['uri']);?>" alt="car" width="61" height="48" />-->
