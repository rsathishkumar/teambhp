...
<div id="footer" class="clearfix">
	...
	?>
	<div class="marT50">
		<a href="<?php if($restofind=='') { echo "http://";} echo $sql_buckleup['field_buckle_up_url_value'];?>" title="<?php echo $sql_buckleup['title'];?>" target="_blank">
