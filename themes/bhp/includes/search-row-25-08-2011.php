		...
		<table>
			<tr>
				...
				<a href="?q=<?php echo $url['alias']; ?>" title="<?php echo $model_row1['title']; ?>">
					<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$review['uri']);?>" alt="<?php echo $model_row1['title']; ?>" width="70" height="53" border="0" />-->
					<img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_review_detail/public/<?php echo str_replace("public://","",$review['uri']);?>" alt="<?php echo $model_row1['title']; ?>" width="70" height="53" border="0" />
				</a>
				</td>
						...
						<div class="viewDropDwn" id="var<?php echo $model_row1['nid']; ?>">
							...
							<div class="clearfix marB10">
								<div class="fleft w140 aln_center">
									<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$review['uri']);?>" alt="<?php echo $model_row1['title']; ?>" width="100" height="75" />-->
									<img src="http://www.team-bhp.com/?q=sites/default/files/styles/medium_medium/public/<?php echo str_replace("public://","",$review['uri']);?>" alt="<?php echo $model_row1['title']; ?>" width="100" height="75" />
								</div>
