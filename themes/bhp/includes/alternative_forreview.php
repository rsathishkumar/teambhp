	...
	<ul>
		...
		$mktitle=@mysqli_fetch_array(mysqli_query("select title from node,field_data_field_nr_make where field_data_field_nr_make.entity_id =".$data_model['nid']." and field_data_field_nr_make.field_nr_make_nid=node.nid"));
			...
			<div class="ReviewBtns">
				<a href="<?php echo url("node/".$data_model['nid'])?>" title="Overview"><img width="47" height="12" alt="<?php echo $mktitle['title']." ".$data_model['title'];?>" src="/themes/bhp/images/buttons/review.png" /></a>
				<a href="#" onClick="getCarID('<?php echo $data_model['nid']; ?>'); return false;" class="add"><img width="57" height="12" alt="Compare" src="/themes/bhp/images/buttons/compare.png" /></a>
			</div>
			</li>
			<?php
