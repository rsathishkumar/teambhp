...
<div class="content clearfix" id="<?php echo $model_row1['nid']; ?>" rel="<?php echo str_replace("review/","", $sql_url['alias']);?>">
	...
	<!-- <img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_compare_car/public/<?php echo str_replace("public://","",$review['uri']);?>" alt="<?php echo $mktitle['title']." ". $model_row1['title']; ?>" width="61" height="46" border="0" /> -->
	<img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_review_detail/public/<?php echo str_replace("public://","",$review['uri']);?>" alt="<?php echo $mktitle['title']." ". $model_row1['title']; ?>" width="61" height="46" border="0" />
