...
<div class="roundAll3 cta newsletter clearfix">
	<div class="newsletterInner">
		...
		/*	if(mysqli_num_rows($sql_chk_email)==0)
			...
			?>
		<h3>Newsletter</h3>
		<div class="marB20">Get your weekly dose of the<br /> Indian Car Scene<br /><br /> <i>Coming soon!</i></div>
	...
	<a class="unsubscribeLink" href='/unsubscribenews'>Click here to unsubscribe</a>
	</div>
	...
	<div class="roundAll3 cta socialMediaBlock clearfix">
		...
		<?php
				...
				/*echo "<a href='/?q=unsubscribenews&e=".base64_encode($da_e['email'])."' target='_blank'>Click here to unsubscribe</a>";
				}*/
				echo "<a href='/?q=unsubscribenews&e=".base64_encode($da_e['email'])."' target='_blank'>Click here to unsubscribe</a>";
			?>
				-->
