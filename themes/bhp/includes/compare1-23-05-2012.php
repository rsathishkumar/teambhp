...
drupal_add_js('if(screen.width<="1024") { var is1024 = 1; var totalLi = 4; } else { var is1024 = 0; var totalLi = 5; } var ownerPos; var speciPos; var featuPos; jQuery(function(){ var ownerHead = jQuery(".ownerHead"); var speciHead = jQuery(".speciHead"); var featuHead = jQuery(".featuHead"); ownerPos = ownerHead.offset(); speciPos = speciHead.offset(); featuPos = featuHead.offset(); jQuery(".infoIcon").css("zIndex","5"); jQuery(".compareHideShow .accTitle").click(function(){ if (jQuery(this).find("h4").css("position")!="fixed") { if (jQuery(this).next("div").css("display")=="none") { jQuery(this).find("h4").removeClass("ui-state-active"); jQuery(this).next("div").fadeIn(600, function(){ ownerPos = ownerHead.offset(); speciPos = speciHead.offset(); featuPos = featuHead.offset(); }); }else { jQuery(this).find("h4").addClass("ui-state-active"); jQuery(this).next("div").fadeOut(600, function(){ ownerPos = ownerHead.offset(); speciPos = speciHead.offset(); featuPos = featuHead.offset(); }); } } return false; }); jQuery(window).scroll(function() { var mainHead = jQuery("head"); var headPos = mainHead.offset(); if (headPos.top>=ownerPos.top){ jQuery(".ownerHead h4").addClass("elementHeadFix"); jQuery(".ownerHead h4").css({ position:"fixed", top:0, zIndex:10 }); jQuery(".ownerHead").next("div").css("paddingTop","48px"); }else { jQuery(".ownerHead h4").removeClass("elementHeadFix"); jQuery(".ownerHead h4").css("position","static"); jQuery(".ownerHead").next("div").css("paddingTop","0"); } if (headPos.top>=(speciPos.top)-48){ jQuery(".speciHead h4").addClass("elementHeadFix"); jQuery(".speciHead h4").css({ position:"fixed", top:48, zIndex:15 }); jQuery(".speciHead").next("div").css("paddingTop","48px"); }else { jQuery(".speciHead h4").removeClass("elementHeadFix"); jQuery(".speciHead h4").css("position","static"); jQuery(".speciHead").next("div").css("paddingTop","0"); } if (headPos.top>=(featuPos.top)-96){ jQuery(".featuHead h4").addClass("elementHeadFix"); jQuery(".featuHead h4").css({ position:"fixed", top:96, zIndex:20 }); jQuery(".featuHead").next("div").css("paddingTop","48px"); }else { jQuery(".featuHead h4").removeClass("elementHeadFix"); jQuery(".featuHead h4").css("position","static"); jQuery(".featuHead").next("div").css("paddingTop","0"); } }); if(is1024==1) { jQuery("td[colspan=\'6\']").each(function(index){ jQuery(this).attr("colspan", "5"); });jQuery("body").addClass("comparePage1024"); jQuery("table.compareTable tr").each(function(index){ jQuery(this).find("td").eq(5).remove();}); } jQuery(".infoIcon").hover(function(){ jQuery(".infoIcon").css("zIndex","5"); jQuery(this).css("zIndex","7"); }); }); function removeTD(id) {var i = jQuery("table#car_details tr:first td").index(jQuery(id).closest("td")); var j = 0; jQuery("table#car_details tr").each(function(index){ 
jQuery(this).find("td").eq(i).remove(); if(jQuery(this).find("td").length>0) { if(jQuery("div.search").length==0) { if(j==0) { jQuery(this).append(\'<td>'.$contentOpt.'</td>\'); jQuery("#car_title tr:first").find("td").eq(5).html("<div class=\"carDetails\"><h3>Add Car</h3></div>");} else {jQuery(this).append("<td></td>");} } else { var flg = true ;for(var k = i;k<=5;k++){if(flg==true) {jQuery("#car_title tr:first").find("td").eq(i).html("<div class=\"carDetails\"><h3>Add Car</h3></div>");flg = false;} 	else { jQuery("#car_title tr:first").find("td").eq(k).html("<div class=\"carDetails\"><h3></h3></div>");}}
jQuery(this).append("<td></td>");} } j++; }); jQuery("#other-details tr").eq(0).find("td").eq(i).html("");jQuery("#other-details tr").eq(1).find("td").eq(i).html("");jQuery("#other-details tr").eq(2).find("td").eq(i).html("");jQuery("#other-details tr").eq(3).find("td").eq(i).html("");jQuery("#compareEngine").find("table tr td").eq(i).html("");jQuery("#compareVariant table.compareTable tr").eq(0).find("td").eq(i).html("");
jQuery("#ownership tr").eq(0).find("td").eq(i).html("");
jQuery("#ownership tr").eq(1).find("td").eq(i).html("");
jQuery("#ownership tr").eq(2).find("td").eq(i).html("");
jQuery("#ownership tr").eq(3).find("td").eq(i).html("");
jQuery("#ownership tr").eq(4).find("td").eq(i).html("");
jQuery("#ownership tr").eq(5).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(1).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(2).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(3).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(4).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(5).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(6).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(7).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(8).find("td").eq(i).html("");
jQuery("#spec-dimension tr").eq(9).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(1).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(2).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(3).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(4).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(5).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(6).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(7).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(8).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(9).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(10).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(11).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(12).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(13).find("td").eq(i).html("");
jQuery("#engine-type tr").eq(14).find("td").eq(i).html("");
jQuery("#spec-suspension tr").eq(1).find("td").eq(i).html("");
jQuery("#spec-suspension tr").eq(2).find("td").eq(i).html("");
jQuery("#spec-suspension tr").eq(3).find("td").eq(i).html("");
jQuery("#spec-suspension tr").eq(4).find("td").eq(i).html("");
jQuery("#spec-suspension tr").eq(5).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(1).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(2).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(3).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(4).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(5).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(6).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(7).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(8).find("td").eq(i).html("");
jQuery("#features-safety tr").eq(9).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(0).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(1).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(2).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(3).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(4).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(5).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(6).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(7).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(8).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(9).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(10).find("td").eq(i).html("");
jQuery("#features-enhancements tr").eq(11).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(0).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(1).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(2).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(3).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(4).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(5).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(6).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(7).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(8).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(9).find("td").eq(i).html("");
jQuery("#features-convinience tr").eq(10).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(0).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(1).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(2).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(3).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(4).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(5).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(6).find("td").eq(i).html("");
jQuery("#features-entertainment tr").eq(7).find("td").eq(i).html("");
