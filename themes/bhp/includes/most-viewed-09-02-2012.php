...
AND node.type = 'news' and node_counter.timestamp and  node_counter.timestamp >=".strtotime("- 6 day")." order by node_counter.totalcount desc limit 0,5");
...
<div class="roundAll5 clearfix mostViewed marB10">
	...
	<?php
		...
		if($num_monthli>0)
			{
	?>
		<div id="mv_tab2" class="mv_tab_content">
			<ul>
				<?php
