										...
										<div class="full_news marT10">
											...
											<div class="fleft newPhotoGallery marB10 clearfix">
												...
												<div class="mainPhoto zoomSingleImg">
														<strong>
														<img id="loadimg" src="/?q=sites/default/files/styles/check_tech_stuff/public/<?php echo str_replace("public://","",$node->field_advice_images['und'][0]['uri']);?>" rel="<?php echo str_replace("public://","",$node->field_advice_images['und'][0]['uri']);?>" class="zoomLt" alt="<?php echo $node->title;?>" style="display:inline"  />
														</strong>
														<img id="hoverimg" src="/?q=sites/default/files/styles/check_tech_stuff_hover/public/<?php echo str_replace("public://","",$node->field_advice_images['und'][0]['uri']);?>" rel="<?php echo str_replace("public://","",$node->field_advice_images['und'][0]['uri']);?>" class="zoomLt" alt="<?php echo $node->title;?>" style="display:none" />
...
$node->field_advice_content['und'][0]['safe_value'][$i]=str_replace("http://www.team-bhp.com","https://www.team-bhp.com",$node->field_advice_content['und'][0]['safe_value'][$i]);														
