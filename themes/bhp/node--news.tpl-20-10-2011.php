							...
							<div class="fleft PhotoGallery">
								...
								if(sizeof($node->field_news_images['und'])>0)
									 ...
									 while($data_news=mysql_fetch_assoc($sql_imglist))
									 	{
									?>
										<a href="http://www.team-bhp.com/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$data_news['uri']);?>" class="lightbox mainPhoto"<?php if($cnt_newsimg==0) {?> style="display:block"<?php } else {?> style="display:none"<?php }?>title="<?php echo $node->title;?>" rel="lightbox[news]">
											...
											<img src="http://www.team-bhp.com/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",$data_news['uri']);?>"<?php if($cnt_newsimg==0) {?> id="mainPhoto"<?php } ?> alt="<?php echo $node->title;?>"  alt="<?php echo $node->title;?> " />
