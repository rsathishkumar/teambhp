	...
	if(isvalid==false)
	...
	else
		{
			 (function ($) {	$.ajax(
			 	{
						  type: "POST",
						  url: '/themes/bhp/ajax/sharebymail.php',
...
var newsletterEmail=document.getElementById('newsletterEmail').value;
	...
	if(isvalid==false)
	...
	else
		{
						 (function ($) {	$.ajax({
						  type: "POST",
						  url: '/themes/bhp/ajax/subscribefronewsletter.php',
...
var newsletterEmail=document.getElementById('newsletterEmail').value;
	...
	if(isvalid==false)
	...
	else
		{
						 (function ($) {	$.ajax({
						  type: "POST",
						  url: '/themes/bhp/unsubscribenews-email.php',
   			 	...
   			 	changeErrorInput("speak_otherval");
		   			...
		   			if(document.getElementById("other").checked==true && document.getElementById("speak_otherval").value=='')
						...
						if($("#"+"speak_otherval").parent("div").find("div.erDiv").html()==null)
								...
								(function ($) 
								{
								$("#"+"speak_otherval").closest("div").append("<div style='display: inline;' class='erDiv'><div class='errorMesg'><span>" + "Please enter email subject" + "</span></div></div>");
								//alert("");
								return false;
								})(jQuery);
								}
