...
function shownews_bycat11111(catname, id)	//for tabs
	{
		(function ($) {	
		    ...
		    $('html, body').animate({scrollTop: $("h1").offset().top-10}, 300, function(){
				...
				$.ajax({
				   type: "POST",
				   url: "/themes/bhp/show_newsbycat.php",
...
function showmodelbycityprice(city)	//for brands dropdown
	{
		...
		$.ajax({
		   type: "POST",
		   url: "/themes/bhp/showmodelbycityprice.php",
		   cache: false,
...
/*************************************************************************************************************************************/	
	function nav_advice11111(id)
	{
		    ...
		    $('html, body').animate({scrollTop: $("h1").offset().top-10}, 300, function(){
				...
				$.ajax({
				   type: "POST",
				   url: "/themes/bhp/show_advicebycat.php",
				   data: q,
				   success: function(data){
				    $("ul.tab li a").removeClass("active");
					$("div#ajax").html(data);
...
/*************************************************************************************************************************************/
	function showthread_bycat111(catname)	//for brands dropdown
	{
		...
		$('html, body').animate({scrollTop: $("h1").offset().top-10}, 300, function(){
			...
			$.ajax({
			   type: "POST",
			   url: "/themes/bhp/show_threadbycat.php",
			   data: "catname="+catname,
			   success: function(data){
			    $("div#ajax").html(data);
				//$("ul.tab li a").removeClass("active");
...
/*************************************************************************************************************************************/
	function show_byalphabet(alphabet)	//for brands dropdown
	{
		...
		/* alert($("#dictionarylist").find("a").attr("rel")+"\n "+ $(this).find("<span>").remove());
		 $(this).find("span>").remove();*/
		$("div#ajax").html('<div style="text-align:center;"><img src="/themes/bhp/images/loader.gif"></div>');
		$.ajax({
		   type: "POST",
		   url: "/themes/bhp/show_byalphabet.php",
...
/*************************************************************************************************************************************/
	...
	//alert(eid+ "/ n"+modle_id);
		...
		$.ajax({
		   type: "POST",
		   url: "/themes/bhp/show_by_engine.php",
...
/*************************************************************************************************************************************/	
	function nav_tstuff(id)
	{
			...
			$('html, body').animate({scrollTop: $("h1").offset().top-10}, 300, function(){
				...
				$.ajax({
				   type: "POST",
				   url: "/themes/bhp/show_tstuff.php",
				   data: q,
				   success: function(data){
				   // $("ul.tab li a").removeClass("active");
					$("div#ajax").html(data);
...
/*************************************************************************************************************************************/	
	function nav_safety(id)
	{
			...
			$('html, body').animate({scrollTop: $("h1").offset().top-10}, 300, function(){
				...
				$.ajax({
				   type: "POST",
				   url: "/themes/bhp/show_safety.php",
				   data: q,
				   success: function(data){
				   // $("ul.tab li a").removeClass("active");
					$("div#ajax").html(data);
...
/*************************************************************************************************************************************/	
	function showmodelbymake(makeid)	//for brands dropdown
	{
				...
				$.ajax({
				   type: "POST",
				   url: "/themes/bhp/show_modelbymake.php",
				   cache: false,
...
/*************************************************************************************************************************************/	
	function show_priceby_city(city,engineid)	//for brands dropdown
	{
		...
		(function ($) {	
			...
			$.ajax({
			   type: "POST",
			   url: "/themes/bhp/show_pricebycity.php",
			   cache: false,
...
/*************************************************************************************************************************************/	
	...
	(function ($) {	
		...
		$.ajax({
		   type: "POST",
		   url: "/themes/bhp/show_priceby_engine.php",
		   cache: false,
...
/*************************************************************************************************************************************/	
	...
	(function ($) {	
		...
		$.ajax({
		   type: "POST",
		   url: "/themes/bhp/unsubscribed.php",
		   cache: false,
...
/*************************************************************************************************************************************/		
	...
	(function ($) {	
		$.ajax({
		   type: "POST",
		   url: "/themes/bhp/updatethreadcounter.php",
		   cache: false,
