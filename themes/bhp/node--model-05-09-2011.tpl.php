							...
							<div class="photogalleryHolder marB10">
								...
								<?php
									...
									if($sql_withoutseqeunce=='')
										{
									$model_imgname="sites/default/files/defaultmodel.jpg";
								
									?>
									<img src="http://www.team-bhp.com/<?php echo $model_imgname;?>" id="mainPhoto" alt="<?php echo $node->title; ?>" width="370" height="278" />
								...
								<?php	
									...
									$model_imgnamelarge="?q=sites/default/files/styles/extra_large_for_review/public/".str_replace("public://","",$model_img['uri']);
									$model_imgnamewithoutseq="?q=sites/default/files/styles/large_review/public/".str_replace("public://","",$model_img['uri']);
									?>
										<a href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" class="lightbox mainPhoto" title="<?php echo $node->title; ?>">
									<img src="http://www.team-bhp.com/<?php echo $model_imgnamewithoutseq;?>" id="mainPhoto" alt="<?php echo $node->title; ?>" width="370" height="278" />
									</a>
									<?php
										}
									}
									...
									if(@mysqli_num_rows($q_withoutseq)>0)
								 	...
								 	<?php
								 		...
								 		while($data_withoutorder_img1111=@mysqli_fetch_array($q_withoutseq))
											...
											$model_imgname="?q=sites/default/files/styles/thumb_review_detail/public/".str_replace("public://","",$sql_imgpath['uri']);
											$model_imgnamelarge="?q=sites/default/files/styles/extra_large_for_review/public/".str_replace("public://","",$sql_imgpath['uri']);
								 	?>
									 <li>
										...
										<a <?php if($count_last==1) {?>class="active"<?php } else if ($count_last==@mysqli_num_rows($q_withoutseq)) { ?>class="last"<?php }?> href="http://www.team-bhp.com/<?php echo $model_imgnamelarge;?>" title="<?php echo $data_withoutorder_img['title'];?>">
											<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> -->
									     	<img src="http://www.team-bhp.com/<?php echo $model_imgname;?>" alt="<?php echo $data_withoutorder_img['title'];?>" width="70" height="53" /> 
										</a>
									</li>
									<?php
											$count_last++;
						...
						<ul class="clearfix" id="compareUL">
							...
							<li class="clearfix">
								<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>" rel="<?php echo str_replace("review/","",$sql_url['alias'])?>">
									...
									<img src="http://www.team-bhp.com/<?php echo $model_modleimgname;?>" alt="<?php echo $data_model['title'];?>" width="61" height="48" />
									</div>
									<p class="desc">
