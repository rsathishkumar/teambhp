...
<div class="article">
	<h1 class="padL20 marB10">News</h1>
		<ul class="tab TLR5 clearfix" id="maincatlist">
			<li><a title="All" class="TLR5<?php if(($cat=='%') or isset($_REQUEST['model']) or isset($_REQUEST['tag'])) { ?> active<?php } ?>" href="#" rel="&page=1&catname=%">All</a></li>
			<li><a title="Indian" class="TLR5<?php if(($cat=='Indian') or (!isset($_REQUEST['catname']) and !isset($_REQUEST['model']) and !isset($_REQUEST['tag']))) { ?> active<?php } ?>" href="#" rel="&page=1&catname=Indian">Indian</a></li>
...
<script type="text/javascript">
nav_news(link='&page=1&catname=Indian');
</script>
