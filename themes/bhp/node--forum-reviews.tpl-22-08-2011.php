	...
	?>
				<div class="article">
							...
							<ul class="tab TLR5 clearfix">
								<li><a href="<?php echo url("node/".$node->field_forum_model['und'][0]['nid']);?>" class="TLR5" title="Overview">Overview</a></li>
								<?php
								if($photos_alias!='')
									{
								?>
								...
								?>
								<li><a href="<?php echo url("node/".$node->nid);?>" class="TLR5 active" title="Forum Reviews">Forum Reviews</a></li>
								<?php
						...
						<div class="tab_container marB10 BLR5">								
							<div class="tab_content forum clearfix" style="display:block">
										...
										<li>
											<div class="clearfix listHolder">
												<div class="fleft w170">
													<a href="<?php echo $sql_link['field_forum_link_url'];?>" title="<?php echo $sql_title['title'];?>" target="_blank">
														<!-- <img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$sql_image['uri']);?>" alt="<?php echo $sql_title['title'];?>" width="165" height="123" /> -->
														<img src="http://www.team-bhp.com/?q=sites/default/files/styles/medium_medium/public/<?php echo str_replace("public://","",$sql_image['uri']);?>" alt="<?php echo $sql_title['title'];?>" width="165" height="123" /> 
													</a>
								...
								<div class="fright" style="padding-top:0" id="sidebar">
									<?php include ("includes/member-threads.php") ?>
						...
						<div class="clearfix padL20">
							<a href="?q=reviews<?php //echo url("node/".$node->field_forum_model['und'][0]['nid']);?>" class="fleft btnLeft">
...
FROM node,file_managed,field_data_field_nr_make,field_data_field_model_dashboard WHERE field_data_field_model_dashboard.field_model_dashboard_fid = file_managed.fid AND field_data_field_model_dashboard.entity_id = node.nid AND node.status =1 AND field_data_field_nr_make.entity_id=field_data_field_model_dashboard.entity_id and node.nid=".$sql_modeldata['field_forum_model_nid']." order by node.changed desc");
						...
						<ul class="clearfix" id="compareUL">
							...
							<li class="clearfix">
								<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>">
									...
									<img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_compare_car/public/<?php echo str_replace("public://","",$data_model['uri']);?>" alt="car" width="61" height="48" />
									</div>
									<p class="desc">
