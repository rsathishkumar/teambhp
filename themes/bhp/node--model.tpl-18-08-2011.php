									...
									<div class="reviewSummery clearfix roundAll5 marB10">
										...
										<div id="firstPage">
											...
											$summary="";
												...
												$summary.="<div class='clearfix InnerPagination fright'><ul class='pagination'><li class='active'><a href='#' class='active' title='go to page 1'>1</a></li><li><a href='#secondPage' title='go to page 2' id='goToNextPage'>2</a></li></ul></div>";
														}
												if($summary!='')
													{
											...
											<div style="display: none;" id="secondPage">
												...
												<?php
													echo "<p>".$smaller_sign."</p>"."<div class='clearfix InnerPagination fright'><ul class='pagination'><li><a href='#prev_page'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a href='#secondPage' title='go to page 2' class='active'>2</a></li></ul></div>";
												?>
											</div>
