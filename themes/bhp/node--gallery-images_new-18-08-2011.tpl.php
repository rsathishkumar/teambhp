...
//$q="SELECT node.title, field_data_field_gallery_model.field_gallery_model_nid, field_data_field_gallery_exterior.field_gallery_exterior_fid,field_data_field_gallery_exterior.field_gallery_exterior_title,field_data_field_gallery_exterior.entity_id, file_managed.uri FROM node, file_managed, field_data_field_gallery_exterior, field_data_field_gallery_model WHERE field_data_field_gallery_exterior.entity_id = field_data_field_gallery_model.entity_id AND file_managed.fid = field_data_field_gallery_exterior.field_gallery_exterior_fid AND field_data_field_gallery_model.field_gallery_model_nid =".$node->field_gallery_model['und'][0]['nid']." AND field_data_field_gallery_model.field_gallery_model_nid = node.nid order by field_data_field_gallery_exterior.field_gallery_exterior_fid desc";
 $q="SELECT distinct(field_gallery_interior_alt) as alt, field_gallery_interior_title as title, field_gallery_interior_fid as fid FROM `field_data_field_gallery_interior` WHERE field_data_field_gallery_interior.entity_id='".$node->nid."' and field_data_field_gallery_interior.field_gallery_interior_alt!='' UNION
SELECT distinct(field_gallery_exterior_alt) as alt, field_gallery_exterior_title as title, field_gallery_exterior_fid as fid  FROM `field_data_field_gallery_exterior` WHERE field_data_field_gallery_exterior.entity_id='".$node->nid."' and field_data_field_gallery_exterior.field_gallery_exterior_alt!=''
UNION SELECT distinct(field_gallery_engine_alt) as alt, field_gallery_engine_title as title, field_gallery_engine_fid as fid  FROM `field_data_field_gallery_engine` WHERE field_data_field_gallery_engine.entity_id='".$node->nid."' and field_data_field_gallery_engine.field_gallery_engine_alt!=''
UNION SELECT distinct(field_gallery_smaller_alt) as alt, field_gallery_smaller_title as title, field_gallery_smaller_fid as fid FROM `field_data_field_gallery_smaller` WHERE field_data_field_gallery_smaller.entity_id='".$node->nid."' and field_data_field_gallery_smaller.field_gallery_smaller_alt!=''
order by alt";
								...
								<div class="carOverview BLR5 marB10">
										...
										<div class="fleft w655 photogalleryHolder clearfix">
											...
											<div id="gallery">
												...
												<span<?php if($cnt==1) {?> class="show"<?php }?>>
													<img src="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$sql_imgpath['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="655" height="480" title="<?php echo $data_ext_img['title'];?>" />
												</span>
												<?php
														$cnt++;
													}
									...
									<div class="jcarousel-skin-tango clearfix">
											...
											while($data_ext_imgnew=mysqli_fetch_array($sql_exterior_new))
														{
													$sql_imgpathnew=mysqli_fetch_array(mysqli_query("select uri from file_managed where fid=".$data_ext_imgnew['fid']));
											...
											<a <?php if($counter==0) {?>class="active"<?php }?>onclick="return showMain(<?php echo $counter;?>);" title="<?php echo $data_ext_imgnew['title'];?>" href="#">
												...
												<img width="165" height="124" alt="<?php echo $data_ext_imgnew['title'];?>" src="http://www.team-bhp.com/?q=sites/default/files/styles/medium_medium/public/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>">
											</a>
											</li>
												<?php
														$counter++;
									...
									?>
										<li>
											<a href="http://www.team-bhp.com/sites/default/files/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>" title="<?php echo $sql_exterior_new['title'];?>" rel="lightbox[all]">
											...
											<img src="http://www.team-bhp.com/?q=sites/default/files/styles/medium_medium/public/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>" alt="<?php echo $sql_exterior_new['title'];?>" width="165" height="124" />
											</a>
										</li>
									<?php
										$counter++;
												...
												if($price_res['maxPrice']>=100000)
													...
													<li class="clearfix">
														<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>">
															<div class="img"><img src="http://www.team-bhp.com/?q=sites/default/files/styles/thumb_compare_car/public/<?php echo str_replace("public://","",$data_model['uri']);?>" alt="<?php echo $data_model['title'];?>" width="61" height="46" title="<?php echo $data_model['title'];?>" /></div>
															<p class="desc">
