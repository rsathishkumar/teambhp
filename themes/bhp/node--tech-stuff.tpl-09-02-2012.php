												...
												if(count($descArray)>1)
												{
													for($i=0; $i<count($descArray); $i++)
														...
														<?php
															...
															$str_toreplace=str_replace("!--smart_paging_autop_filter--","",$str_toreplace);
															$str_toreplace=str_replace("!--smart_paging_filter_done--","",$str_toreplace);
															$str_toreplace=str_replace("!--smart_paging_filter--","",$str_toreplace);
															$str_toreplace=str_replace('<em class="placeholder">',"",$str_toreplace);
															$str_toreplace=str_replace("</em>","",$str_toreplace);
															$str_toreplace=str_replace("/p","",$str_toreplace);
