			...
			<tr>
						...
						<div class="viewDropDwn" id="var<?php echo $model_row1['nid']; ?>">
							...
							<div class="clearfix marB10">
								...
								<div class="fleft fancyCarDetails">
									...
									<a title="Review Overview" href="<?php echo $url['alias']; ?>"><img width="47" height="12" alt="Review" src="themes/mobilebhp/images/buttons/review.png" border="0"></a>
									<a href="#" onclick="getCarID('<?php echo $model_row1['nid']; ?>'); return false;"><img width="47" height="12" alt="Compare" src="themes/mobilebhp/images/buttons/compare.png" border="0"></a>
								</div>
							</div><!-- clearfix -->
							<?php
				...
				<td class="owners padL20">
					...
					<h4 class="fleft">Owners liked</h4>
						...
						<a href="<?php echo $url['alias']; ?>" title="Review Overview"><img src="themes/mobilebhp/images/buttons/review.png" alt="Review" width="57" height="12" /></a>
						<a href="#" onclick="getCarID('<?php echo $model_row1['nid']; ?>'); return false;"><img src="themes/mobilebhp/images/buttons/compare.png" alt="Compare" width="57" height="12" /></a>												
						</div>
					</div>
					<ul class="bulletList">
					<?php
