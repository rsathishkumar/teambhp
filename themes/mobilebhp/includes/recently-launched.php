...
$sql_cityname=@mysqli_query("select DISTINCT(city) from team_bhp_variant_price where city!='Delhi' and city!='Others' order by city");
?>
<div class="recently_launched roundAll5 pad10 clearfix" id="recent_launch">
		...
		<div class="clearfix">
			...
			<div class="filterByPrice">
				...
				<select id="onroadprice" onchange="showmodelbycityprice(this.value);">
					<option value='Delhi'>Delhi</option>
					<?php
					if(mysqli_num_rows($sql_cityname)>0)
						{
						while($data_city=mysqli_fetch_array($sql_cityname))
							{
					?>
					<option value="<?php echo $data_city['city'];?>"><?php echo $data_city['city'];?></option>		
					<?php
							}
						}
					?>
			...
			<li class="clearfix">
				...
				<div class="Rec_carinfo">
					...
					<div class="ReviewBtns">
						<a href="<?php echo url("node/".$data_model['nid'])?>" title="Overview"><img src="themes/mobilebhp/images/buttons/review.png" alt="Review"
		...
		<ul class="carListing MostViewList noBorder">
			...
			<li class="clearfix"> 
				...
				<div class="Rec_carinfo">
					...
					?>
					<div class="ReviewBtns">
						<a href="<?php echo url("node/".$mostviewdata['nid'])?>" title="Overview"><img src="themes/mobilebhp/images/buttons/review.png" alt="Review" width="47" height="12" /></a>
						<a href="#" class="add" onclick="getCarID('<?php echo $mostviewdata['nid']; ?>'); return false;"><img src="themes/mobilebhp/images/buttons/compare.png" alt="Compare" width="57" height="12" /></a>													
					</div>
				</div>
			</li>
			<?php
