...
<div class="roundAll5 clearfix mostViewed marB10">
	...
	<div class="mv_tab_container">
		...
		<div id="mv_tab1" class="mv_tab_content BLR5" style="display:block">
			...
			while($weekly_ht=mysqli_fetch_array($sql_news_weekly_viewd))
				...
				?>
				<li class="clearfix"  rel="<?php if($restofindweekly=='') { echo "http://";} echo $d_thread['field_ht_forum_url'];?>" onclick="return updatethreadcounter('<?php if($restofindweekly=='') { echo "http://";} echo $d_thread['field_ht_forum_url'];?>','<?php echo $weekly_ht['nid'];?>')">
					<div class="listBox clearfix">
						<div class="fleft w70 marR10">
							<a class="listImg" title="<?php echo $weekly_ht['title'];?>" href="<?php if($restofindweekly=='') { echo "http://";} echo $d_thread['field_ht_forum_url'];?>" >
								<strong>
						...
						<a title="<?php echo $weekly_noaddata->title;?>" href="<?php if($restofindweekly=='') { echo "http://";} echo $d_thread['field_ht_forum_url'];?>"><?php echo $weekly_noaddata->title;?></a>
	...
	?>
		<div id="mv_tab2" class="mv_tab_content" style="display:<?php if($num_weekly==0){?>block<?php } else { ?>none<?php }?>">
			...
			?>
			<li class="clearfix" rel="<?php if($restofindmonthly=='') { echo "http://";} echo $d_threadmonthly['field_ht_forum_url'];?>" onclick="return updatethreadcounter('<?php if($restofindmonthly=='') { echo "http://";} echo $d_threadmonthly['field_ht_forum_url'];?>','<?php echo $monthly_ht['nid'];?>')">
					<div class="listBox clearfix">
						<div class="fleft w70 marR10">
							<a class="listImg" href="<?php if($restofindmonthly=='') { echo "http://";} echo $d_threadmonthly['field_ht_forum_url'];?>" title="<?php echo $monthly_noaddata->title;?>">
								<strong>
						...
						<a href="<?php if($restofindmonthly=='') { echo "http://";} echo $d_threadmonthly['field_ht_forum_url'];?>"  title="<?php echo $monthly_ht['title'];?>"><?php echo $monthly_noaddata->title;?></a>
					</div><!-- list box -->
				</li>
			<?php
				}
