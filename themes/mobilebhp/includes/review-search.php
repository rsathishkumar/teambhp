...
drupal_add_js('var isAdded =0; jQuery(document).ready(function() { jQuery(".searchby").click(function() { jQuery("span.totalMatches").html("<img src=\"/themes/mobilebhp/images/loader.gif\" width=\"16\" height=\"16\" alt=\"loading...\" title=\"loading...\" />"); var data="city="+jQuery("#onRoad").val()+"&minPrice="+jQuery("#minPrice").val()+"&maxPrice="+jQuery("#maxPrice").val(); var bodyVals = []; jQuery("#body_style:checked").each(function() { bodyVals.push(jQuery(this).val()); }); if(bodyVals!="") {data += "&bs="+bodyVals; } var fuelVals = []; jQuery("#fuel:checked").each(function() { fuelVals.push(jQuery(this).val()); }); if(fuelVals!="") {data += "&fuel="+fuelVals; }  var transVals = []; jQuery("#trans:checked").each(function() { transVals.push(jQuery(this).val()); }); if(transVals!="") {data += "&trans="+transVals; }  jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/ajaxRes.php", data: data, success: function(data){ jQuery("span.totalMatches").html(data); } }); }); jQuery("#reset").click(function(){ jQuery("#searchPreference")[0].reset(); jQuery("span.checkbox").removeAttr("style"); jQuery("#slider-range").slider( "option", "values", [3, 10]); jQuery("#mini-amount").html("3 L"); jQuery("#max-amount").html("10 L"); jQuery("#mini-amount").css("left", parseInt(jQuery(".ui-slider-handle").eq(0).attr("style").substr(jQuery(".ui-slider-handle").eq(0).attr("style").indexOf("left:")+6, (jQuery(".ui-slider-handle").eq(0).attr("style").indexOf("%;")+1)-jQuery(".ui-slider-handle").eq(0).attr("style").indexOf("left:")))+"%"); jQuery("#max-amount").css("left", parseInt(jQuery(".ui-slider-handle").eq(1).attr("style").substr(jQuery(".ui-slider-handle").eq(1).attr("style").indexOf("left:")+6, (jQuery(".ui-slider-handle").eq(1).attr("style").indexOf("%;")+1)-jQuery(".ui-slider-handle").eq(1).attr("style").indexOf("left:")))+"%"); jQuery("span.totalMatches").html("<img src=\"/themes/mobilebhp/images/loader.gif\" width=\"16\" height=\"16\" alt=\"loading...\" title=\"loading...\" />"); var data="city="+jQuery("#onRoad").val()+"&minPrice=300000&maxPrice=1000000"; var bodyVals = []; jQuery("#body_style:checked").each(function() { bodyVals.push(jQuery(this).val()); }); if(bodyVals!="") {data += "&bs="+bodyVals; } var fuelVals = []; jQuery("#fuel:checked").each(function() { fuelVals.push(jQuery(this).val()); }); if(fuelVals!="") {data += "&fuel="+fuelVals; }  var transVals = []; jQuery("#trans:checked").each(function() { transVals.push(jQuery(this).val()); }); if(transVals!="") {data += "&trans="+transVals; }  jQuery.ajax({ type: "POST", async: false, url: "themes/mobilebhp/includes/ajaxRes.php", data: data, success: function(data){ jQuery("span.totalMatches").html(data); } }); return false; }); jQuery("#showReview").click(function() { if(jQuery("#selModel").val()!="Select Model") { location.href="?q="+jQuery("#selModel").val(); } else if(jQuery("#selMake").val()!="Select Make") { jQuery.post("?q=session", { searchType: "make", make: jQuery("#selMake").val() }); jQuery("#recent_launch").css("display", "none"); jQuery("#review_result").html("<div class=\"loader\">&nbsp;</div>"); jQuery("#review_result").css("display", "block"); var data = "make="+jQuery("#selMake").val(); data = data+"&isAdded="+isAdded; if(isAdded==0) { isAdded++; } jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/review-result.php", data: data, success: function(data){ jQuery("#review_result").html(data); } }); } return false; }); jQuery("#showPrefResult").click(function() { jQuery("#recent_launch").css("display", "none"); jQuery("#review_result").html("<div class=\"loader\">&nbsp;</div>"); jQuery("#review_result").css("display", "block"); var data="city="+jQuery("#onRoad").val()+"&minPrice="+jQuery("#minPrice").val()+"&maxPrice="+jQuery("#maxPrice").val(); var bodyVals = []; jQuery("#body_style:checked").each(function() { bodyVals.push(jQuery(this).val()); }); if(bodyVals!="") {data += "&bs="+bodyVals; } var fuelVals = []; jQuery("#fuel:checked").each(function() { fuelVals.push(jQuery(this).val()); }); if(fuelVals!="") {data += "&fu
el="+fuelVals; }  var transVals = []; jQuery("#trans:checked").each(function() { transVals.push(jQuery(this).val()); }); if(transVals!="") {data += "&trans="+transVals; } data = data+"&isAdded="+isAdded; if(isAdded==0) { isAdded++; } jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/review-result-preferences.php", data: data, success: function(data){ jQuery("#review_result").html(data); } }); return false; }); }); function getModel(id){jQuery.ajax({type: "POST",url: "themes/mobilebhp/includes/getModel.php",data: "make="+id,success: function(data){ jQuery("select#selModel").html(data);}}); } function sort(order, make, city){jQuery("#review_result").html("<div class=\"loader\">&nbsp;</div>"); jQuery("#review_result").css("display", "block"); jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/review-result.php", data: "order="+order+"&make="+make+"&city="+city, success: function(data){ jQuery("#review_result").html(data); } }); } function sortPreferences(city, minPrice, maxPrice, bs, fuel, trans, orderBy, order){jQuery("#review_result").html("<div class=\"loader\">&nbsp;</div>"); jQuery("#review_result").css("display", "block"); var data="city="+city+"&minPrice="+minPrice+"&maxPrice="+maxPrice+"&orderBy="+orderBy+"&order="+order; if(bs!=0) { data=data+"&bs="+bs; } if(fuel!=0) { data=data+"&fuel="+fuel; } if(trans!=0) { data=data+"&trans="+trans; } jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/review-result-preferences.php", data: data, success: function(data){ jQuery("#review_result").html(data); } }); } function city(make, city){jQuery("#review_result").html("<div class=\"loader\">&nbsp;</div>"); jQuery("#review_result").css("display", "block"); jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/review-result.php", data: "city="+city+"&make="+make, success: function(data){ jQuery("#review_result").html(data); } }); } function showVariants(id) { jQuery(".viewDropDwn").css("display", "none"); jQuery("#"+id).css("display", "block"); } function closeDiv() { jQuery(".viewDropDwn").css("display", "none"); } /*function changePrice(id){var url = Drupal.settings.basePath + "?q=price"; jQuery.ajax({type: "POST",url: url,data: "city="+id,success: function(data){ jQuery("div.priceRange").html(data);}}); }*/ function changePrice(){ jQuery("span.totalMatches").html("<img src=\"/themes/mobilebhp/images/loader.gif\" width=\"16\" height=\"16\" alt=\"loading...\" title=\"loading...\" />"); var data="city="+jQuery("#onRoad").val()+"&minPrice="+jQuery("#minPrice").val()+"&maxPrice="+jQuery("#maxPrice").val(); var bodyVals = []; jQuery("#body_style:checked").each(function() { bodyVals.push(jQuery(this).val()); }); if(bodyVals!="") {data += "&bs="+bodyVals; } var fuelVals = []; jQuery("#fuel:checked").each(function() { fuelVals.push(jQuery(this).val()); }); if(fuelVals!="") {data += "&fuel="+fuelVals; }  var transVals = []; jQuery("#trans:checked").each(function() { transVals.push(jQuery(this).val()); }); if(transVals!="") {data += "&trans="+transVals; }  jQuery.ajax({ type: "POST", async: false, url: "themes/mobilebhp/includes/ajaxRes.php", data: data, success: function(data){ jQuery("span.totalMatches").html(data); } }); } function reset(){ jQuery("div#review_result").css("display", "none"); jQuery("div#recent_launch").css("display", "block"); jQuery("#searchPreference")[0].reset(); jQuery("span.checkbox").removeAttr("style"); jQuery("#slider-range").slider( "option", "values", [3, 10]); jQuery("#mini-amount").html("3 L"); jQuery("#max-amount").html("10 L"); jQuery("#mini-amount").css("left", parseInt(jQuery(".ui-slider-handle").eq(0).attr("style").substr(jQuery(".ui-slider-handle").eq(0).attr("style").indexOf("left:")+6, (jQuery(".ui-slider-handle").eq(0).attr("style").indexOf("%;")+1)-jQuery(".ui-slider-handle").eq(0).attr("style").indexOf("left:")))+"%"); jQuery("#max-amount").css("left", parseInt(jQuery(".ui-slider-handle").eq(1).attr("style").substr(jQuery(".ui-slider-handle").eq(1).attr("style").indexOf("left:")+6, (jQuery(".ui-slider-handle").eq(1).attr("style").indexOf("%;")+1)-jQuery(".ui-slider-handle").eq(1)
.attr("style").indexOf("left:")))+"%"); jQuery("span.totalMatches").html("<img src=\"/themes/mobilebhp/images/loader.gif\" width=\"16\" height=\"16\" alt=\"loading...\" title=\"loading...\" />"); var data="city="+jQuery("#onRoad").val()+"&minPrice=300000&maxPrice=1000000"; var bodyVals = []; jQuery("#body_style:checked").each(function() { bodyVals.push(jQuery(this).val()); }); if(bodyVals!="") {data += "&bs="+bodyVals; } var fuelVals = []; jQuery("#fuel:checked").each(function() { fuelVals.push(jQuery(this).val()); }); if(fuelVals!="") {data += "&fuel="+fuelVals; }  var transVals = []; jQuery("#trans:checked").each(function() { transVals.push(jQuery(this).val()); }); if(transVals!="") {data += "&trans="+transVals; }  jQuery.ajax({ type: "POST", async: false, url: "themes/mobilebhp/includes/ajaxRes.php", data: data, success: function(data){ jQuery("span.totalMatches").html(data); } }); return false; }', 'inline');
$mkid = '';
...
?>
			...
			jQuery.post("?q=session", { searchType: "make", make: jQuery("#selMake").val() }); jQuery("#recent_launch").css("display", "none"); jQuery("#review_result").html("<div class=\"loader\">&nbsp;</div>"); jQuery("#review_result").css("display", "block"); var data = "make="+<?php echo $mkid['nid']?>; data = data+"&isAdded="+isAdded; if(isAdded==0) { isAdded++; } jQuery.ajax({ type: "POST", url: "themes/mobilebhp/includes/review-result.php", data: data, success: function(data){ jQuery("#review_result").html(data); } });  return false;
			});
			</script>
<?php
		}
