...
?><div class="roundAll5 vintageCars">
	<div id="vintageCars" class="picBox">
		...
		$cntvcar++;
			...
			$res_vcars=@mysqli_query($sql_vcars);
		?>
		<!--  <img id="vintage-2" style="display:none" src="themes/mobilebhp/images/temp/4x4Car.jpg" width="280" height="228" alt="4 x 4 Cars"/>
		<img id="vintage-3" style="display:none" src="themes/mobilebhp/images/temp/vintageCars.jpg" width="280" height="228" alt="Vintage Cars"/>-->
	</div>
