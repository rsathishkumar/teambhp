...
<div class="home-wrapper">
    ...
    <!--ad wrapper-->
        <div class="ad-wrapper text-center" id="div-gpt-ad-1355997698878-0">
            ad goes here
    ...
    <section class="home-services">
        <div class="container-fluid">
            <ul>
                ...
                <li><a href="http://classifieds.team-bhp.com/used-car-price-check" class="text-center"><span class="circle"><i
                                class="icon-card"></i></span><span class="text text-center">PRICE CHECK</span></a></li>
                <li><a href="/tech-stuff" class="text-center"><span class="circle"><i class="icon-technical"></i></span><span
                ...
                <li><a href="/advice" class="text-center"><span class="circle"><i
                                class="icon-advice"></i></span><span class="text text-center">ADVICE</span></a></li>
