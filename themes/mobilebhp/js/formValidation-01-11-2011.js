	...
	if(isvalid==false)
	...
	else
		{
			 (function ($) {	$.ajax(
			 	{
						  type: "POST",
						  url: 'http://www.team-bhp.com/themes/mobilebhp/ajax/sharebymail.php',
...
var newsletterEmail=document.getElementById('newsletterEmail').value;
	...
	if(isvalid==false)
	...
	else
		{
						 (function ($) {	$.ajax({
						  type: "POST",
						  url: 'http://www.team-bhp.com/themes/mobilebhp/ajax/subscribefronewsletter.php',
...
var newsletterEmail=document.getElementById('newsletterEmail').value;
	...
	if(isvalid==false)
	...
	else
		{
						 (function ($) {	$.ajax({
						  type: "POST",
						  url: 'http://www.team-bhp.com/themes/mobilebhp/unsubscribenews-email.php',
		...
		if(isvalid==true)
			{
			 (function ($) {	$.ajax({
						  type: "POST",
						  url: 'http://www.team-bhp.com/themes/mobilebhp/ajax/speak.php',
