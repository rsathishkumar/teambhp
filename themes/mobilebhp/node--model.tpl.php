<link rel="stylesheet" href="/themes/mobilebhp/css/lightbox.css" type="text/css" />
<?php
...
<script type="text/javascript">		    
		(function ($) {  $(function(){
			...
			 $("ul.gallery_thumb li:last-child").css("margin-right","0");
			//Most Viewed tab 				
			...
			/*$(".gallery_thumb li").click(function(){
				$("#innerdivphotogalleryHolder").find("a").css("display","none");
				$(".gallery_thumb li a").removeClass("active");
    			$(this).find("a").addClass("active");
    			$("img#mainPhoto").css("display","block");
    			$("#mainfoto").css("display","block");
    			$("#lboxsrc").css("display","block");
    			...
    			$("#mainfoto").attr("href", $(this).find("a").attr("href").replace("check_large_review", "check_extra_large_for_review"));
    			$("#lboxsrc").attr("href", $(this).find("a").attr("href").replace("check_large_review", "check_extra_large_for_review"));
    			
    			//$(".lightbox").attr("href", $(this).find("a").attr("href").replace("check_large_review", "check_extra_large_for_review"));
    		...
    		$(".gallery_thumb li").click(function(){
    			...
    			{
	    			$("#innerdivphotogalleryHolder").find(".mainPhoto").css("display", "none");
	    			$("#innerdivphotogalleryHolder").find(".zoomIt").css("display", "none");
    				$("#innerdivphotogalleryHolder").find(".mainPhoto").eq(index).fadeIn(600);
    				$("#innerdivphotogalleryHolder").find(".zoomIt").eq(index).fadeIn(600);
			...
			$("#goToNextPage").click(function(){
				...
				$("#goToNextPagefordetail").click(function(){
				$("#firstPage").css("display","none");
				$("#secondPage").css("display","block");
				$("#altrnativecars").css("display","block");
			...
			$("#prev_pagefordetail").click(function(){
				$("#firstPage").css("display","block");
				$("#secondPage").css("display","none");
				$("#altrnativecars").css("display","none");
				$('html, body').animate({scrollTop: $($(this).attr("href")).offset().top-10}, 300);
				return false;
				});	
	...
	<div class="article">
			...
			<ul class="tab TLR5 clearfix">
				...
				if($forum_review_alias!='')
					{
				?>
				<li><a href="<?php echo "/?q=forum-reviews&modelname=".strtolower($node->title);//$forum_review_alias['alias'];?>" class="TLR5" title="Forum Reviews">Forum Reviews</a></li>
				<?php
					}
					...
					<div class="clearfix marT10">
						<div class="fleft w380 PhotoGallery">									
							<div class="photogalleryHolder marB10">
								<div id="innerdivphotogalleryHolder">
									<?php
									$cnt_withseq=0;
									if($num_exterior>0)
									{
										while($d_singleextimg=mysqli_fetch_array($sql_exterior_img))
										{
											$sql_imgpathnew=mysqli_fetch_array(mysqli_query("select uri from file_managed where fid=".$d_singleextimg['fid']));
									?>
										<a href="/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>" class="lightbox active mainPhoto"<?php if($cnt_withseq==0) {?> style="display:block"<?php } else {?> style="display:none"<?php } if($cnt_withseq==0) {?> id="mainfoto" <?php }?> title="<?php echo $d_singleextimg['title']; ?>" rel="lightbox[model]">
										<!--<img src="/sites/default/files/<?php echo str_replace("public://","",$d_singleextimg['uri']);?>" id="mainPhoto" alt="<?php echo $node->title; ?>" width="370" height="278" />-->
											<strong>
												<img src="/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",str_replace("+","%2B",$sql_imgpathnew['uri']));?>"<?php if($cnt_withseq==0) {?> id="mainPhoto" alt="<?php echo $d_singleextimg['title']; ?>"<?php }?> />
											</strong>
										</a>
										<a href="/?q=sites/default/files/styles/check_extra_large_for_review/public/<?php echo str_replace("public://","",$sql_imgpathnew['uri']);?>" title="<?php echo $d_singleextimg['title']; ?>" class="lightbox zoomIt" rel="lightbox[model]" <?php if($cnt_withseq==0) {?> style="display:block" id="lboxsrc" <?php } else {?> style="display:none" title="<?php echo $d_singleextimg['title']; ?>"<?php } ?> >&nbsp;</a>
									<?php
											$cnt_withseq++;
										}
									}
									...
									{
										$sql_withoutseq=@mysqli_query("SELECT field_data_field_gallery_interior.delta as delta , field_gallery_interior_title as title, field_gallery_interior_fid as fidint FROM `field_data_field_gallery_interior`,field_data_field_gallery_model WHERE field_data_field_gallery_interior.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' UNION SELECT field_data_field_gallery_exterior.delta as delta, field_gallery_exterior_title as title, field_gallery_exterior_fid as fidint FROM `field_data_field_gallery_exterior`, field_data_field_gallery_model WHERE field_data_field_gallery_exterior.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' UNION SELECT field_data_field_gallery_engine.delta as delta, field_gallery_engine_title as title, field_gallery_engine_fid as fidint FROM `field_data_field_gallery_engine`,field_data_field_gallery_model WHERE field_data_field_gallery_engine.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' UNION SELECT field_data_field_gallery_smaller.delta as delta, field_gallery_smaller_title as title, field_gallery_smaller_fid as fidint FROM `field_data_field_gallery_smaller`,field_data_field_gallery_model WHERE field_data_field_gallery_smaller.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' order by delta limit 0,4");
										if(@mysqli_num_rows($sql_withoutseq)==0)
										{
											$model_imgname="sites/default/files/defaultmodel_278.gif";
								
									?>
											<img src="/<?php echo $model_imgname;?>" id="mainPhoto" alt="<?php echo $node->title; ?>" />
								
									<?php	
										}
									else
									{
										while($sql_withoutseqeunce=@mysqli_fetch_array($sql_withoutseq))
										{
											$model_img=@mysqli_fetch_array(mysqli_query("select uri from file_managed where fid=".$sql_withoutseqeunce['fidint']));
											$model_imgnamelarge="?q=sites/default/files/styles/check_extra_large_for_review/public/".str_replace("public://","",$model_img['uri']);
											$model_imgnamewithoutseq="?q=sites/default/files/styles/check_large_review/public/".str_replace("public://","",str_replace("+","%2B",$model_img['uri']));
								?>
											<a href="/<?php echo $model_imgnamelarge;?>" class="lightbox mainPhoto" title="<?php echo $node->title; ?>" <?php if($cnt_withseq==0) {?> style="display:block"<?php } else {?> style="display:none"<?php } if($cnt_withseq==0) {?> id="mainfoto"<?php }?> rel="lightbox[model]">
										    <img src="/<?php echo $model_imgnamewithoutseq;?>" <?php if($cnt_withseq==0) {?> id="mainPhoto"<?php }?> alt="<?php echo $node->title; ?>" />
										    <a href="/<?php echo $model_imgnamelarge;?>" title="<?php echo $d_singleextimg['title']; ?>" class="lightbox zoomIt" rel="lightbox[model]" <?php if($cnt_withseq==0) {?> style="display:block" id="lboxsrc" <?php } else {?> style="display:none" title="<?php echo $d_singleextimg['title']; ?>"<?php }?>>&nbsp;</a></a>
								<?php
											$cnt_withseq++;
										}
									}
								...
								<!-- <a href="/?q=sites/default/files/styles/large_review/public/<?php echo str_replace("public://","",$d_singleextimg['uri']);?>" title="<?php echo $make_res['title']." ".$node->title; ?> " class="zoomIt lightbox">&nbsp;</a>
									</a>
								<?php
										/*}
										else
										{*/
									?>
									<a href="/?q=sites/default/files/styles/large_review/public/<?php echo str_replace("public://","",$sql_model['uri']);?>" title="<?php echo $make_res['title']." ".$node->title; ?> " class="zoomIt lightbox">&nbsp;</a>
									</a>-->
									<?php	
										//}
								...
								?>
								 <ul class="gallery_thumb clearfix marT10 marB5">
								 	<?php
										...
										?>
										 <li<?php if($count_last==4) {?> class="last"<?php }?>>
										
											<a <?php if($count_last==1) {?>class="active"<?php } else if ($count_last==$num_exterior) { ?>class="last"<?php }?> href="/?q=sites/default/files/styles/check_large_review/public/<?php echo str_replace("public://","",str_replace("+","%2B",$sql_imgpath['uri']));?>" title="<?php echo $data_ext_img['title'];?>">
												<!-- <img src="/sites/default/files/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> -->
												<strong>
												<img src="/?q=sites/default/files/styles/check_thumb_review_detail/public/<?php echo str_replace("public://","",str_replace("+","%2B",$sql_imgpath['uri']));?>" alt="<?php echo $data_ext_img['title'];?>" /> 
												</strong>
											</a>
										</li>
										<?php
								...
								{
									$res_withoutorder11111="SELECT field_data_field_gallery_interior.delta as delta , field_gallery_interior_title as title, field_gallery_interior_fid as fid FROM `field_data_field_gallery_interior`,field_data_field_gallery_model WHERE field_data_field_gallery_interior.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' UNION SELECT field_data_field_gallery_exterior.delta as delta, field_gallery_exterior_title as title, field_gallery_exterior_fid as fid FROM `field_data_field_gallery_exterior`, field_data_field_gallery_model WHERE field_data_field_gallery_exterior.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' UNION SELECT field_data_field_gallery_engine.delta as delta, field_gallery_engine_title as title, field_gallery_engine_fid as fid FROM `field_data_field_gallery_engine`,field_data_field_gallery_model WHERE field_data_field_gallery_engine.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' UNION SELECT field_data_field_gallery_smaller.delta as delta, field_gallery_smaller_title as title, field_gallery_smaller_fid as fid FROM `field_data_field_gallery_smaller`,field_data_field_gallery_model WHERE field_data_field_gallery_smaller.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' order by delta limit 4";
									$q_withoutseq=mysqli_query($res_withoutorder11111);
									if(@mysqli_num_rows($q_withoutseq)>0)
									{
								?>
									    <ul class="gallery_thumb clearfix marT10 marB5">
										<?php
										$count_last=1;
										while($data_withoutorder_img1111=@mysqli_fetch_array($q_withoutseq))
										{
											$sql_imgpath=@mysqli_fetch_array(mysqli_query("select uri from file_managed where fid=".$data_withoutorder_img1111['fid']));
											$model_imgname="?q=sites/default/files/styles/check_thumb_review_detail/public/".str_replace("public://","",str_replace("+","%2B",$sql_imgpath['uri']));
											$model_imgnamelarge="?q=sites/default/files/styles/check_large_review/public/".str_replace("public://","",str_replace("+","%2B",$sql_imgpath['uri']));
										?>
											<li<?php if($count_last==4) {?> class="last"<?php }?>>
										
											<a <?php if($count_last==1) {?>class="active"<?php } else if ($count_last==@mysqli_num_rows($q_withoutseq)) { ?>class="last"<?php }?> href="/<?php echo $model_imgnamelarge;?>" title="<?php echo $data_withoutorder_img['title'];?>">
												<!-- <img src="/sites/default/files/<?php echo str_replace("public://","",$data_ext_img['uri']);?>" alt="<?php echo $data_ext_img['title'];?>" width="70" height="53" /> -->
												<strong>
												<img src="/<?php echo $model_imgname;?>" alt="<?php echo $data_withoutorder_img['title'];?>" /> 
												</strong>
											</a>
											</li>
										<?php
	...
	//$sql_modelengine=@mysqli_query("select field_spec_nr_engine_type_nid from field_data_field_spec_nr_engine_type where entity_id in(".substr($e_id,0,-1).") and bundle ='specifications'");
						...
						<?php
							...
							<div class="clearfix marT20 marB20">
										View the in-depth review of this car by a Team-BHP Moderator: <br />
									<!--  <a href="#" id="overviewmore" title="<?php echo $node->title;?>" class="underline"><?php echo $node->title;?> Review</a>-->
									 <a href="<?php if($restofindmod=='') { echo "http://";} echo $node->field_model_forum_link['und'][0]['url'];?>" target="_blank" title="<?php echo $make_res['title'].": ". $node->title." Review";?>" class="underline"><?php /*echo $make_res['title'].": ". $node->title;*/ echo $node->title; ?> Review</a>
							</div>
							<?php
									}
									}
						...
						<div class="reviewInfo clearfix">
								...
								<div class="aln_right fright marT5">
									<a class="btnRight fright"  href="/forum/newthread.php?do=Review" target="_blank">
						...
						?>
								...
								<div class="reviewbar marB10 roundAll5 clearfix"><!-- Team BHP Reviews -->
										<div class="Reviewhead clearfix">
												...
												<a target="_blank" href="/forum/newthread.php?do=Review" class="btnRight fright">														<span>Submit Your Review</span>
													</a>
												</div>	
										</div>
								...
								<div class="fleft w685">
									<div class="reviewSummery clearfix roundAll5 marB10">
										...
										<div id="firstPage">
											...
											$summary="";
												...
												if($summary!='')
													...
													//echo "<p>".$smaller_sign."</p>"."<div class='clearfix InnerPagination fright'><ul class='pagination'><li><a href='#'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a  title='go to page 2' class='active'>2</a></li></ul></div>";
														if($node->field_review_smaller['und'][0]['value']!='')
														{
														echo "<p>".trim($summary." "."<a href='#secondPage' id='goToNextPagefordetail' class='underline' title='The Smaller Yet Significant Things'>"."The Smaller Yet Significant Things >"."</a>")."</p>";	
														}
														else
														{
											...
											<div style="display: none;" id="secondPage">
												...
												<?php
													echo "<p>".$smaller_sign." <a href='#firstPage' id='prev_pagefordetail' onclick='return false;' title='Overview'>< Overview"."</a></p>"."<div class='clearfix InnerPagination fright'><ul class='pagination'><li><a href='#firstPage'  title='go to page 1' id='prev_page'>1</a></li><li class='active'><a  class='active'>2</a></li></ul></div>";
												?>
											</div>
									...
									<div class="clearfix padL20 marB10">
										<a class="btnLeft fleft" href="/reviews">
...
if($numberofrows>0)
		...
		$sql_url=@mysqli_fetch_array(mysqli_query("select alias from url_alias where source='node/".$node->nid."'"));
	    $sql_sequenceimgmainimg=@mysqli_fetch_array(mysqli_query("SELECT distinct(field_gallery_interior_alt) as alt, field_gallery_interior_title as title, field_gallery_interior_fid as fid FROM `field_data_field_gallery_interior`,field_data_field_gallery_model WHERE field_data_field_gallery_interior.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$$node->nid."' and field_data_field_gallery_interior.field_gallery_interior_alt!='' UNION SELECT distinct(field_gallery_exterior_alt) as alt, field_gallery_exterior_title as title, field_gallery_exterior_fid as fid FROM `field_data_field_gallery_exterior`, field_data_field_gallery_model WHERE field_data_field_gallery_exterior.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' and field_data_field_gallery_exterior.field_gallery_exterior_alt!='' UNION SELECT distinct(field_gallery_engine_alt) as alt, field_gallery_engine_title as title, field_gallery_engine_fid as fid FROM `field_data_field_gallery_engine`,field_data_field_gallery_model WHERE field_data_field_gallery_engine.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' and field_data_field_gallery_engine.field_gallery_engine_alt!='' UNION SELECT distinct(field_gallery_smaller_alt) as alt, field_gallery_smaller_title as title, field_gallery_smaller_fid as fid FROM `field_data_field_gallery_smaller`,field_data_field_gallery_model WHERE field_data_field_gallery_smaller.entity_id=field_data_field_gallery_model.entity_id and field_data_field_gallery_model.field_gallery_model_nid='".$node->nid."' and field_data_field_gallery_smaller.field_gallery_smaller_alt!='' order by alt limit 0,4"));
