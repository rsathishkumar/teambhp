...
if(strstr($make_res['field_make_url_url'], 'http://')!='')
{
...
<div class="article">
		...
		<ul class="tab TLR5 clearfix">
			...
			<?php
					...
					{
			?>
			<li><a href="<?php echo "/?q=forum-reviews&modelname=".strtolower($model_res['title']);//$forum_review_alias['alias'];?>" class="TLR5" title="Forum Reviews">Forum Reviews</a></li>
			<?php
					}
			?>
			...
			<div class="carOverview marB10 BLR5">
				...
				<div class="clearfix marT10 clearfix">
					...
					<div class="fright w225">
						...
						<?php //include ("themes/mobilebhp/includes/manufacturer-website.php") ?>
						<?php include ("themes/mobilebhp/includes/must-read-articles-price.php"); ?>
					</div><!-- 225 -->
				</div><!-- clearfix -->
			</div><!-- car over view -->
						...
						<ul class="clearfix" id="compareUL">
							...
							<li class="clearfix">
								<div class="content firstContent clearfix" id="<?php echo $data_model['nid']; ?>">
									<div class="img">
										<strong>
									<!-- <img src="/sites/default/files/<?php echo str_replace("public://","",$data_model['uri']);?>" alt="car" width="61" height="46" />-->
									<img src="/<?php echo $model_modleimgname;?>" alt="<?php echo $mktitle['title']." ".$data_model['title'];?>"  />
									</strong>
									</div>
									<p class="desc">
